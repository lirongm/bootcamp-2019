...
gapminder07[gapminder07$country=="Mexico",3]
...
gapminder07$lifeExp_highlow<-ifelse(gapminder07$lifeExp>mean(gapminder07$lifeExp),"High","Low")
table(gapminder07$lifeExp_highlow)
...
hist(gapminder07$lifeExp, main="Histogram of Life Expectancy",xlab="Life Expectancy")

# Bonus: Change the `breaks = ` argument from its default setting and see what happens.
hist(gapminder07$lifeExp,main="Histogram of Life Expectancy",xlab="Life Expectancy",breaks=20)
...
plot(gapminder07$gdpPercap,gapminder07$lifeExp,main="Scatterplot of Life Expectancy and GDP per Capita",xlab="GDP per Capita")
